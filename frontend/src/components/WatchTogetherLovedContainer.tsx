...
console.log(storedFriend)
  ...
  if (movies.length > 0) {
    return (
      <div className="flex flex-col lg:max-w-4xl w-full max-w-full md:mx-auto justify-start ">
        <div className="mx-5 lg:mx-0 mt-5 rounded bg-orange p-5 text-2xl font-semibold text-blue-500">
    ...
    return (
      <div className="mx-auto my-5 lg:max-w-4xl rounded bg-orange px-5 py-12 text-center text-3xl font-medium text-blue-500">
